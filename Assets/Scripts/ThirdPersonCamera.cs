...
public class ThirdPersonCamera : MonoBehaviour
{
    ...
    public float mMinDistance = 3.0f;
    public float mDamping = 1.0f;
    public float mMinPitch = -30.0f;
    public float mMaxPitch = 30.0f;
    public float mRotationSpeed = 50.0f;
    public float mRepositionStrength = 1.0f;




    public LayerMask mObjectMask;
    ...
    void Start()
    {
        ...
        ObjectConstants.ObjectMask = mObjectMask;
        CameraConstants.RepositionStrength = mRepositionStrength;
